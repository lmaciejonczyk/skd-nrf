...
.. note::
   To activate the Multiprotocol BLE extension of this sample, modify :makevar:`CONF_FILE` by applying ``overlay-multiprotocol_ble.conf``.
   For more information, see :ref:`important-build-vars` in the Zephyr documentation.
