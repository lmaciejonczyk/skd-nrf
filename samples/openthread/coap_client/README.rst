...
When the device is working as Minimal Thread Device (MTD), additional LED and Button are used:
...
For more information, see the Working with Thread user guide.
...
.. note::
   ...
   For more information, see :ref:`important-build-vars`.
...
After building the sample and programming it, the device starts in the SED mode with LED 3 disabled.
