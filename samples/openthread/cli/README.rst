...
The Thread CLI sample support UART and USB CDC ACM as serial transports.
The UART transport is supported by default.
...
* For the USB transport support, set :file:`overlay-usb.conf`.
