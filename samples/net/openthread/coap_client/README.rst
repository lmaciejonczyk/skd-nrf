...
This sample uses :ref:`Zephyr CoAP API<zephyr:coap_sock_interface>` for communication, which is the prefered API to use for new CoAP applications.
...
The following buttons of the client development kit are used by this sample:
